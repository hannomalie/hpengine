...
public interface Drawable {
    ...
    default void draw(Camera cameraEntity, FloatBuffer modelMatrix, int entityIndex, boolean isVisible, boolean isSelected, boolean linesOnly) { draw(cameraEntity, modelMatrix, ProgramFactory.getInstance().getFirstpassDefaultProgram(), entityIndex, isVisible, isSelected);}
    ...
    int draw(Camera camera, FloatBuffer modelMatrix, Program firstPassProgram, int entityIndex, boolean isVisible, boolean isSelected, boolean drawLines);
