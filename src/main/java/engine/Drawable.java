...
public interface Drawable {
    ...
    default void draw(RenderExtract extract, Camera cameraEntity, FloatBuffer modelMatrix, Program firstPassProgram, int entityIndex, int entityBaseIndex) { draw(new DrawConfiguration(extract, cameraEntity, modelMatrix, firstPassProgram, entityIndex, entityBaseIndex, true, false, false)); }
