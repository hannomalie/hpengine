...
public interface Drawable {
    ...
    default void draw(Camera cameraEntity, FloatBuffer modelMatrix, int entityIndex, boolean isVisible, boolean isSelected) { draw(cameraEntity, modelMatrix, getFirstPassProgram(), entityIndex, isVisible, isSelected);}
