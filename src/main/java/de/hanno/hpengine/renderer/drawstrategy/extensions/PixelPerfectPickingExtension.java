...
public class PixelPerfectPickingExtension implements RenderExtension {
    ...
    public void renderFirstPass(FirstPassResult firstPassResult, RenderState renderState) {
        ...
        if (Input.PICKING_CLICK == 1) {
            ...
            floatBuffer.rewind();
            Vector2f ratio = new Vector2f(Float.valueOf(Config.WIDTH) / Float.valueOf(ApplicationFrame.WINDOW_WIDTH),
                    Float.valueOf(Config.HEIGHT) / Float.valueOf(ApplicationFrame.WINDOW_HEIGHT));
