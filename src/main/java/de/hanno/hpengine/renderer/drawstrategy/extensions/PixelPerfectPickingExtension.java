...
public class PixelPerfectPickingExtension implements RenderExtension {
    ...
    public void renderFirstPass(RenderState renderState, FirstPassResult firstPassResult) {
        ...
        if (Input.PICKING_CLICK == 1) {
            ...
            floatBuffer.rewind();
            Vector2f ratio = new Vector2f(Float.valueOf(Config.WIDTH) / Float.valueOf(Engine.WINDOW_WIDTH),
                    Float.valueOf(Config.HEIGHT) / Float.valueOf(Engine.WINDOW_HEIGHT));
