...
public class TheQuadExampleMoving {
	...
	private void setupTextures() {
		texIds[0] = this.loadPNGTexture("/assets/textures/techtrends.png", GL13.GL_TEXTURE0);
		texIds[1] = this.loadPNGTexture("/assets/textures/techtrends.png", GL13.GL_TEXTURE0);
