...
val InternalTextureFormat.isCompressed: Boolean
    get() = when(this) {
        ALPHA4, ALPHA8, ALPHA12, ALPHA16, LUMINANCE4, LUMINANCE8, LUMINANCE12, LUMINANCE16, LUMINANCE4_ALPHA4,
        LUMINANCE6_ALPHA2, LUMINANCE8_ALPHA8, LUMINANCE12_ALPHA4, LUMINANCE12_ALPHA12, LUMINANCE16_ALPHA16,
        INTENSITY, INTENSITY4, INTENSITY8, INTENSITY12, INTENSITY16, R3_G3_B2, RGB4, RGB5, RGB8, RGB10,
        RGB12, RGB16, RGBA2, RGBA4, RGB5_A1, RGBA8, RGB10_A2, RGBA12, RGBA16, TEXTURE_RED_SIZE,
        TEXTURE_GREEN_SIZE, TEXTURE_BLUE_SIZE, TEXTURE_ALPHA_SIZE, TEXTURE_LUMINANCE_SIZE, TEXTURE_INTENSITY_SIZE,
        PROXY_TEXTURE_1D, PROXY_TEXTURE_2D, RGBA32F, RGB32F, RGBA16F, RGB16F, DEPTH_COMPONENT24,
        SRGB8_ALPHA8, RG16F, R16I, R32F, DEPTH24_STENCIL8 -> false

        COMPRESSED_SRGB_ALPHA_S3TC_DXT5, COMPRESSED_RGBA_S3TC_DXT5 -> true
    }
val InternalTextureFormat.isSRGBA: Boolean
    get() = when(this) {
        ALPHA4, ALPHA8, ALPHA12, ALPHA16, LUMINANCE4, LUMINANCE8, LUMINANCE12, LUMINANCE16, LUMINANCE4_ALPHA4,
        LUMINANCE6_ALPHA2, LUMINANCE8_ALPHA8, LUMINANCE12_ALPHA4, LUMINANCE12_ALPHA12, LUMINANCE16_ALPHA16,
        INTENSITY, INTENSITY4, INTENSITY8, INTENSITY12, INTENSITY16, R3_G3_B2, RGB4, RGB5, RGB8, RGB10,
        ...
        TEXTURE_GREEN_SIZE, TEXTURE_BLUE_SIZE, TEXTURE_ALPHA_SIZE, TEXTURE_LUMINANCE_SIZE, TEXTURE_INTENSITY_SIZE,
        PROXY_TEXTURE_1D, PROXY_TEXTURE_2D, RGBA32F, RGB32F, RGBA16F, RGB16F, DEPTH_COMPONENT24,
        RG16F, R16I, R32F, DEPTH24_STENCIL8, COMPRESSED_RGBA_S3TC_DXT5 -> false

        SRGB8_ALPHA8, COMPRESSED_SRGB_ALPHA_S3TC_DXT5 -> true
    }
