...
class MaterialRibbonTask(materialRibbonBand: MaterialRibbonBand): RibbonTask("Material", materialRibbonBand), EditorRibbonTask {
    override fun reloadContent() = bands.toList().filterIsInstance<ReloadableBand>().forEach { it.reload() }
}
...
class MaterialRibbonBand(val addResourceContext: AddResourceContext,
                         ...
                         val selectionSystem: SelectionSystem): ReloadableBand, JRibbonBand("Material", null) {
