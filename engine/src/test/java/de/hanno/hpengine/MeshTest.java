...
public class MeshTest extends TestWithEngine {
    ...
    public void loadsPlaneCorrectly() throws Exception {
        StaticModel plane = new OBJLoader().loadTexturedModel(engine.getScene().getMaterialManager(), new File(Directories.engineDir + "/assets/models/plane.obj"));
    ...
    public void calculatesLodsCorrectly() throws Exception {
        StaticModel plane = new OBJLoader().loadTexturedModel(engine.getScene().getMaterialManager(), new File(Directories.engineDir + "/assets/models/doublePlane.obj"));
        Mesh planeMesh = plane.getMesh(0);
	...
	public void loadsSphereAndTransformsCorrectly() throws Exception {
        ...
        StaticModel sphere = new OBJLoader().loadTexturedModel(engine.getScene().getMaterialManager(), new File(Directories.engineDir + "/assets/models/sphere.obj"));
