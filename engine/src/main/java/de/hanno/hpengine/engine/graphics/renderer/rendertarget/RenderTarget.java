...
public class RenderTarget {
    ...
    protected GpuContext<OpenGl> gpuContext;
    protected int mipMapCount = -1;
    private String name;

    protected RenderTarget(GpuContext<OpenGl> gpuContext) {
        this.gpuContext = gpuContext;
    }

    public RenderTarget(GpuContext<OpenGl> gpuContext, RenderTargetBuilder renderTargetBuilder) {
        this(gpuContext);
    ...
    public ByteBuffer getTargetTexturedata() {
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, getRenderedTexture(0));
        GL11.glGetTexImage(GL_TEXTURE_2D, 0, GL11.GL_RGB, GL11.GL_UNSIGNED_BYTE, pixels);
    ...
    /**
     * @return a byte buffer with the depth de.hanno.hpengine.texture data or null if this rendertarget doesn't use depth attachment
     */
