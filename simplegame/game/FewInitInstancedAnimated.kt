...
class FewInitInstancedAnimated @Inject constructor(engine: Engine<*>) {
    init {
        try {
            val loaded = LoadModelCommand(engine.directories.gameDir.resolve("assets/models/doom3monster/monster.md5mesh"), "cube", engine.scene.materialManager, engine.directories.gameDir).execute()
